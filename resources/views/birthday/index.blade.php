            ...
            <div class="search-bar">
                <form action="" method="GET" class="d-flex w-100">
                    ...
                    <div class="checkbox-options">
                        ...
                        <label><input type="checkbox" name="birthday_cake" /> Birthday Cake</label>
                ...
                <div class="package-container">
                    ...
                    <div class="package-info">
                        ...
                        <ul>
                            ...
                            @endif
                            @if ($package->birthday_cake)
                                <li>Birthday Cake Included</li>
                            @endif
                        ...
                        <a href="{{ route('birthday.show', ['id' => $package->id]) }}" class="read-more-btn">Read More</a>
                    </div>
                </div>
            </div>
        @endforeach
