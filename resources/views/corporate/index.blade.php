...
<head>
    ...
    <title>Eventique - Birthday Packages</title>
        ...
        <div class="search-bar">
            <form action="" method="GET" class="d-flex w-100">
                <div class="filter-option">
                    ...
                    <select id="party-type" name="party_type" class="form-select">
                ...
                <div class="checkbox-options">
                    ...
                    <label><input type="checkbox" name="corporate_catering" /> Corporate Catering</label>
...
<div class="row">
    @foreach ($packages as $package)
        @php
            $imagePath = asset($package->image_url);
        @endphp
        <div class="col-md-12">
            <div class="package-container">
                <div class="package-img-wrapper">
                    <div class="package-img" style="background-image: url('{{ $imagePath }}');"></div>
                </div>
                ...
                <div class="package-info">
                    ...
                    <ul>
                        ...
                        @endif
                        @if ($package->corporate_catering)
                            <li>Corporate Catering Included</li>
                        @endif
                    ...
                    <a href="{{ route('corporate.show', ['id' => $package->id]) }}" class="read-more-btn">Read More</a>
                </div>
            </div>
        </div>
    @endforeach
