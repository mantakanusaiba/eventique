...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p><strong>Wedding Cake:</strong> {{ $package->wedding_cake ? 'Included' : 'Not Included' }}</p>
            <p><strong>Extra Decorations:</strong> {{ $package->extra_decorations ? 'Included' : 'Not Included' }}</p>

            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('wedding.index') }}" class="btn btn-secondary">← Back to Packages</a>
                <a href="{{ route('wedding.show', ['id' => $package->id]) }}#booking" class="btn btn-custom">Book Now</a>
            </div>
        </div>
    </div>
</div>
